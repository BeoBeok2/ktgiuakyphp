...
if (isset($_POST["btnsubmit"])) {
    ...
    // Xử lý kết quả
    if (!$result) {
        header("Location: list_product.php?failure");
    } else {
...
<form method="post">
    ...
    <div class="row">
        <div class="submit">
            <input type="submit" name="btnsubmit" value="Cập nhật nhân viên">
        </div>
    </div>
...
if (isset($_GET["inserted"])) {
    echo "<h2>Cập nhật nhân viên thành công</h2>";
}
